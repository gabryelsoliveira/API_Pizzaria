    ...
    try {
        ...
        if (
            ...
            if ($bebida->delete() && $bebida->nome) {
                ...
                echo json_encode(
                    array('Mensagem' => 'Bebida Não Encontrada ou Não Foi Possível Excluir')
                );
            }
            ...
            echo json_encode(
                array('Mensagem' => 'Dados Incompletos. Não foi possível excluir a Bebida.')
            );
        }
    } catch (Exception $e) {
